  ...
  >
    <div className='absolute inset-0 flex justify-end m-3 card-img_hover'>
      <div
        ...
        className='bg-blue-600 hover:bg-blue-500 transition-colors duration-300 w-10 h-10 rounded-full flex justify-center items-center cursor-pointer transform hover:scale-110' // Scaling effect added
      >
        <FaLinkedin size={20} className='text-white' /> {/* LinkedIn icon in white color */}
      </div>
    </div>
